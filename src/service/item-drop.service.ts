...
purchasables as (
  ...
  from market_item
  where quantity >= 20 and quality != 'Corrupted' and quality != 'Inscribed' and quality != 'Auspicious' -- corrupted usually overprice shit and inscribed is random pretty much
),
inventory_counts as (
